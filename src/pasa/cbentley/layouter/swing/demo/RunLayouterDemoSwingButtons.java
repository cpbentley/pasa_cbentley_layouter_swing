...
public class RunLayouterDemoSwingButtons extends RunLayouterDemoSwingAbstract {

   public RunLayouterDemoSwingButtons(IConfigU configU) {
      super(configU);
      constructHelpers();
   }
   ...
   public static void main(String[] args) {
      ...
      RunLayouterDemoSwingButtons runner = new RunLayouterDemoSwingButtons(configU);
