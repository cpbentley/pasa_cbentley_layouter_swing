...
public class RunLayouterDemoSwingPozeePoint extends RunLayouterDemoSwingAbstract {

   private JPanel               panelCenterOrange;

   private LayoutableAdapterForJComponent panelCenterOrangeLayout;

   public RunLayouterDemoSwingPozeePoint(IConfigU configU) {
      super(configU);
   ...
   public static void main(String[] args) {
      ...
      RunLayouterDemoSwingPozeePoint runner = new RunLayouterDemoSwingPozeePoint(configU);
